...
Remove-Item -Path "$($GW2Path)arcdps_unofficial_extras.dll" -Force
...
Invoke-WebRequest "https://github.com/Krappa322/arcdps_unofficial_extras_releases/releases/latest/download/arcdps_unofficial_extras.dll" -OutFile "$($GW2Path)arcdps_unofficial_extras.dll"
